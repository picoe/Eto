...
namespace Eto.Platform.GtkSharp.Forms.Controls
{
	...
	public interface IDataColumnHandler
	{
		...
		void BindCell (IDataViewHandler grid, ICellDataSource source, int columnIndex, ref int dataIndex);
	}
	
	public class DataColumnHandler<T, W> : WidgetHandler<T, W>, IDataColumn, IDataColumnHandler
		where T: Gtk.TreeViewColumn
		where W: DataColumn
	{
		Cell dataCell;
		bool autoSize;
		bool editable;
		bool cellsAdded;
		IDataViewHandler grid;
		
		public DataColumnHandler ()
		{
			Control = (T)new Gtk.TreeViewColumn ();
			AutoSize = true;
			Resizable = true;
		}
		...
		public void BindCell (IDataViewHandler grid, ICellDataSource source, int columnIndex, ref int dataIndex)
		{
			this.grid = grid;
			if (dataCell != null) {
