...
namespace Eto.Test.Sections.Layouts.TableLayoutSection
{
	...
	public class ScalingSection : Scrollable
	{
		public ScalingSection()
		{
			...
			tableLayout = new TableLayout(1, 1) { BackgroundColor = Colors.Blue, Size = size, Spacing = new Size(5, 5), Padding = new Padding(10) };
			...
			tableLayout = new TableLayout(2, 2) { BackgroundColor = Colors.Blue, Size = size, Spacing = new Size(5, 5), Padding = new Padding(10) };
			...
			tableLayout = new TableLayout(3, 3) { BackgroundColor = Colors.Blue, Size = size, Spacing = new Size(5, 5), Padding = new Padding(10) };
