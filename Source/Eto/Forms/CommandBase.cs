...
namespace Eto.Forms
{
	...
	{
		void CopyFrom(CommandBase action);
	}

	public partial class CommandBase : InstanceWidget
	{
		#region Members
		...
		protected CommandBase (Generator g, Type type, bool initialize = true) 
			: base(g, type, initialize)
		{
		}

		public CommandBase(string id, string text, EventHandler<EventArgs> activated, params Keys[] accelerators)
		...
		protected CommandBase(string id, string text, Image image, EventHandler<EventArgs> activated)
		...
		protected CommandBase(string id, string text, EventHandler<EventArgs> activated)
			: this(id, text)
		{
			Clicked += activated;
		}
		
		protected CommandBase(string id, string text) : base(null, null as IWidget)
		{
			this.ID = id;
			this.Text = text;
		}
		
		protected CommandBase() : base(null, null as IWidget)
		{
		}

		public virtual void CopyFrom(CommandBase a)
		{
