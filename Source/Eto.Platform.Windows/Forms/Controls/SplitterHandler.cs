	...
	public class SplitterHandler : WindowsControl<SWF.SplitContainer, Splitter>, ISplitter
	{
		...
		public SplitterOrientation Orientation
		{
			get
			{
				...
				{
					default:
					case SWF.Orientation.Horizontal: return SplitterOrientation.Horizontal;
					case SWF.Orientation.Vertical: return SplitterOrientation.Vertical;
				}
			}
			set
			{
				...
				{
					default:
					case SplitterOrientation.Horizontal: Control.Orientation = SWF.Orientation.Horizontal; break;
					case SplitterOrientation.Vertical: Control.Orientation = SWF.Orientation.Vertical; break;
				}
			}
		}
		...
		void c1_VisibleChanged(object sender, EventArgs e)
		{
			...
			if (panel1 != null && ((IWindowsControl)panel1.Handler).InternalVisible) Control.Panel1Collapsed = false;
			else Control.Panel1Collapsed = true;
		}

		void c2_VisibleChanged(object sender, EventArgs e)
		{
			if (panel2 != null && ((IWindowsControl)panel2.Handler).InternalVisible) Control.Panel2Collapsed = false;
			else Control.Panel2Collapsed = true;
		}
