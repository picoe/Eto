...
namespace Eto.Addin.VisualStudio.Win.Wizards
{
	public static class EtoInitializer
	{
		...
		{
			w.Resources.MergedDictionaries.Add(new System.Windows.ResourceDictionary { Source = new Uri("pack://application:,,,/Eto.Addin.VisualStudio.Win;component/theme/WindowStyles.xaml", UriKind.RelativeOrAbsolute) });
		}
	}
}
